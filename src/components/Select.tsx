      ...
      <div className="flex w-full flex-col gap-1">
        ...
        <div className="relative flex items-center">
          <select
            ...
            disabled={disabled}
            className={clsx(
              'w-full appearance-none rounded-md border border-[var(--ds-border)] bg-[var(--ds-surface)] text-[var(--ds-text)] outline-none transition-colors focus:border-[var(--ds-border-focused)] disabled:cursor-not-allowed disabled:bg-[var(--ds-background-disabled)] disabled:text-[var(--ds-text-disabled)]',
              sizeClass[size],
